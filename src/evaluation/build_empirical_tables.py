...
def make_table(metrics: dict, targets, row_specs, caption: str, label: str,
               fontsize: str = "scriptsize") -> str:
    """row_specs: list of (display_label, model_key). targets: ordered list.
    fontsize: tabular font size. All four 9-column empirical tables use 'scriptsize'
    so they sit uniformly within the JBES text width."""
