...
def make_table(metrics: dict, targets, row_specs, caption: str, label: str,
               fontsize: str = "footnotesize") -> str:
    """row_specs: list of (display_label, model_key). targets: ordered list.
    fontsize: tabular font size; the loser tables (with UNRATE's wide values) use
    'scriptsize' to stay within the JBES text width, the rest 'footnotesize'."""
    L = [f"% Auto-generated by build_empirical_tables.py -- do not edit by hand.",
         "\\begin{table}[!ht]", "\\centering",
         "{\\" + fontsize + "\\setlength{\\tabcolsep}{4pt}\\begin{tabular}{l ccc ccc ccc}", "\\toprule",
